...
[![coverage](https://markusberg.github.io/ltpa/badges/coverage-3.0.0-beta.1.svg)](https://github.com/markusberg/ltpa/actions)
...
The full [API documentation](./docs/README.md) is automatically generated by [TypeDoc](https://typedoc.org) from the JSDoc comments.
